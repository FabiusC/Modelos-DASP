...
public class SearchManager extends JFrame {
  ...
  public static final String SOFTWARE_SRCH = "Software SQL Statement";
  ...
  public SearchManager() throws Exception {
    ...
    cmbSearchType.addItem(SearchManager.SOFTWARE_SRCH);
...
class BuilderFactory {
  public UIBuilder getUIBuilder(String str) {
    ...
    } else if (str.equals(SearchManager.SOFTWARE_SRCH)){
      builder = new SoftwareEnterpriseBuilder();
  }
    return builder;
  }
}
