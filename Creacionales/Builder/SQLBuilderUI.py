...
class SQLBuilderUI(Toplevel):
    ...
    HEADHUNTER = "Headhunter SQL Statement"
    EXIT = "Exit"
    ...
    def __init__(self, master):
        ...
        self.__cmbSearchType["values"] = [SQLBuilderUI.BLANK,SQLBuilderUI.CANDIDATE, SQLBuilderUI.EMPLOYER, SQLBuilderUI.HEADHUNTER]
